...
import os
from src.fraud_detection.constants import training_pipeline
...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.feature_store_file_path: str = os.path.join(
            self.data_ingestion_dir, training_pipeline.DATA_INGESTION_FEATURE_STROE_DIR, training_pipeline.FILE_NAME
        )
