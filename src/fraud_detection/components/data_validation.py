from src.fraud_detection.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
...
from src.fraud_detection.constants.training_pipeline import SCHEMA_FILE_PATH
from scipy.stats import ks_2samp
import pandas as pd
import sys, os
from src.fraud_detection.utils.main_utils.utils import read_yaml_file, write_yaml_file
    ...
    def initiate_data_validation(self)-> DataValidationArtifact:
        try:
            ...
            if len(error_message) > 0:
                ...
                logging.info("Numeric columns existance validation completed. No errors found.")
